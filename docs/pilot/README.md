# Pilot Program — KesbYar

بسته آمادگی onboarding مشتریان پایلوت واقعی.

| سند | مخاطب |
|-----|--------|
| [pilot-onboarding-package.md](./pilot-onboarding-package.md) | overview |
| [onboarding-checklist.md](./onboarding-checklist.md) | CS / sales |
| [workspace-setup-checklist.md](./workspace-setup-checklist.md) | ops قبل از دعوت |
| [operator-quickstart.md](./operator-quickstart.md) | ADMIN مشتری |
| [support-escalation.md](./support-escalation.md) | support team |
